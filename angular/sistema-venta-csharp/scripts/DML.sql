...
--('ventilador cooler master',5,20,200,1),
--('mini ventilador lenono',5,15,200,1)
...
Scaffold-DbContext "Server=(local); DataBase=DBVentas; Trusted_Connection=True; TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer